...
class MainLogInScreen(tk.Frame):
    def __init__(self, master):
        ...
        tk.Label(
            self,
            text="Account system to your app",
            bg="grey",
            width="300",
            height="2",
            font=("Calibri", 13),
        ...
        tk.Button(
            ...
            text="Login",
            width="30",
            command=lambda: master.switch_frame(SignInScreen),
            pady=10,
        ).pack()
        tk.Label().pack()
        tk.Button(
            ...
            text="Register",
            width="30",
            command=lambda: master.switch_frame(RegistrationScreen),
            pady=10,
        ).pack()
...
class SignInScreen(tk.Frame):
    def __init__(self, master):
        ...
        username_entry_log = tk.Entry(
            self, textvariable=self.username_verify, font=("Calibri", 13)
        ).pack()

        tk.Label(self, text="Password * ", font=("Calibri", 13)).pack()
        password_entry_log = tk.Entry(
            self, textvariable=self.password_verify, font=("Calibri", 13), show="*"
        ).pack()
    ...
    def login_verify(
        self, username_to_verify, password_to_verify, username_entry, password_entry
    ):
        ...
        def user_not_found():
            messagebox.showerror(
                "Wrong username", "User not found, try another username."
            )
...
class RegistrationScreen(tk.Frame):
    def __init__(self, master):
        ...
        # Username entry
        self.label = tk.Label(self, text="Username * ", font=("Calibri", 13)).grid(
        ...
        self.username_error_label = tk.Label(
            self, text="", font=("Calibri", 10), fg="red"
        )
        self.username_error_label.grid(row=3, column=0, columnspan=2)

        # Password entry
        tk.Label(self, text="Password * ", font=("Calibri", 13)).grid(
            row=4, column=0, columnspan=2
        )
        password_entry = tk.Entry(
            self, textvariable=self.password, font=("Calibri", 13), show="*"
        )
        ...
        tk.Label(self, text="Confirm password * ", font=("Calibri", 13)).grid(
            row=7, column=0, columnspan=2
        )
        password_confirmation_entry = tk.Entry(
            self,
        ...
        self.password_confirmation_error_label = tk.Label(
            self, text="", font=("Calibri", 10), fg="red"
        )
        self.password_confirmation_error_label.grid(row=9, column=0, columnspan=2)

        # Name entry
        tk.Label(self, text="Name * ", font=("Calibri", 13)).grid(
        ...
        # Surname entry
        tk.Label(self, text="Surname * ", font=("Calibri", 13)).grid(
        ...
        self.surname_error_label = tk.Label(
            self, text="", font=("Calibri", 10), fg="red"
        )
        self.surname_error_label.grid(row=15, column=0, columnspan=2)

        # Email entry
        tk.Label(self, text="Email * ", font=("Calibri", 13)).grid(
        ...
        # Age entry
        tk.Label(self, text="Age * ", font=("Calibri", 13)).grid(
        ...
        tk.Label(self, text="Nationality * ", font=("Calibri", 13)).grid(
            row=22, column=0, columnspan=2
        )
        nationality_entry = AutocompleteCombobox(
            self,
            textvariable=self.nationality,
            font=("Calibri", 13),
            completevalues=nationalities,
        )
        nationality_entry.grid(row=23, column=0, columnspan=2)
        self.nationality_error_label = tk.Label(
            self, text="", font=("Calibri", 10), fg="red"
        )
        ...
        tk.Label(self, text="Gender * ", font=("Calibri", 13)).grid(
            row=25, column=0, columnspan=2
        )
        tk.Radiobutton(
            self,
            text="Female",
        ...
        tk.Radiobutton(
            ...
            font=("Calibri", 14),
            command=male(),
        ).grid(row=26, column=1)

        # Phone number entry
        tk.Label(self, text="Phone number * ", font=("Calibri", 13)).grid(
            row=27, column=0, columnspan=2
        )
        phone_number_entry = tk.Entry(
            self, textvariable=self.phone_number, font=("Calibri", 13)
        )
        phone_number_entry.grid(row=28, column=0, columnspan=2)
        self.phone_number_error_label = tk.Label(
            self, text="", font=("Calibri", 10), fg="red"
        )
        ...
        registration_button = tk.Button(
            ...
            command=lambda: self.register_user(
                self.register_data, self.entries, self.error_labels
            ),
            font=("Calibri", 13),
        )
        ...
        self.error_labels = [
            ...
            self.surname_error_label,
            self.email_error_label,
            self.age_error_label,
            self.nationality_error_label,
        ...
        password_confirmation_entry.bind(
            "<FocusIn>", self.password_confirmation_color_white
        )
    ...
    def register_user(self, register_data, entries, error_labels):
        ...
        validation_table = check_entries(
            self.infos, entries, error_labels, validation_table
        )
